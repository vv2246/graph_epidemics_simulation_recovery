...
def spKMC_SEIR_full_state(g_base__, epi_params__, source__, debug__=0): 
    ...
    if ("g", "spkmc_graph") not in g_base__.properties:
        print("WARNING: Graph does not have spkmc_graph properrty!!! Make sure, you know what you are doing! \
            or call generate_directed_graph(g__) from spKMC_unitTests.py ")
    ...
    if type(source__)==list:
        if len(source__)==1:
            ...
            print("## Multiple source initial condition ##", end =" ")
